...
@pytest.mark.parametrize(
    "list1, list2, expected", [([1, 2, 3], [5, 8, 11], [6, 10, 14])]
)
def test_list_add(
...
def test_la_invalid_list_length_error(
    list1: typing.List[int], list2: typing.List[int]
) -> None:
...
@pytest.mark.parametrize(
    "in_list, expected", [([6, 9, 7, 8], True), ([1, 4, 3, 2], False)]
)
