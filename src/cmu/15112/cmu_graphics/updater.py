...
def drawSelectionScreen(most_recent_version):
    Label("Version %s of CMU Graphics" % most_recent_version, 200, 25, size=25)
    Label("is available for download", 200, 60, size=25)
    ...
    Label(
        "Skip This Version", 200, 290 + (75 / 2), align="center", fill="white", size=25
    )
