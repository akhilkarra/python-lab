...
@pytest.mark.parametrize(
    "score, expected",
    {(98, "A+"), (95, "A"), (85, "B+"), (82, "B"), (78, "C+"), (70, "C"), (67, "D"), (51, "F"), (21, "I"), (0, "I")}
)
...
@pytest.mark.parametrize(
    "a, b, c, expected",
    {(3, 4, 5, True), (4, 5, 3, True), (5, 4, 3, True), (5, 3, 4, True), (3, 11, 12, False), (11, 12, 3, False)}
)
...
def test_q1_1960_IMO(expected: list) -> None:
