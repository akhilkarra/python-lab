...
def test_list_add(list1: list[int], list2: list[int], expected: list[int]) -> None:
...
def test_la_invalid_list_length_error(list1: list[int], list2: list[int]) -> None:
...
def test_find_winner(ttt_list: list[str], expected: str) -> None:
...
def test_is_jolly(in_list: list[int], expected: bool) -> None:
